    ...
    <div className="p-6 space-y-6 font-sans">
      ...
      <div className="flex justify-between items-center">
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-lg text-sm hover:opacity-80 transition"
        >
          <ArrowLeft size={14} />
          Back to Notes
        </button>
