    ...
    <section className="py-32 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <span className="inline-flex rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium">
        ...
        <div className="relative mt-24">
          ...
          {/* Center Line */}
          <div className="hidden lg:block absolute top-10 left-0 right-0 h-[2px] bg-slate-200" />
          ...
          <div className="grid gap-8 lg:grid-cols-6">
            ...
            {steps.map((step, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="hidden lg:flex absolute -top-10 left-1/2 -translate-x-1/2 h-5 w-5 rounded-full border-4 border-white bg-blue-600 shadow-md" />
                ...
                <div className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                  ...
                  <div className="text-5xl font-bold text-slate-100 transition-all duration-300 group-hover:text-blue-100">
                    {step.number}
                  </div>
        ...
        <div className="mt-24 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col items-center justify-between gap-6 text-center lg:flex-row lg:text-left">
            ...
            <button className="rounded-full bg-slate-900 px-8 py-3 font-medium text-white transition hover:bg-slate-800">
              Start Your Journey
            </button>
          </div>
        </div>
